...
class MainWindowLayout(QMainWindow):
    ...
    def __init__(self, app, *args):
        ...
        self.useRmerge = QRadioButton('Use R_merge range')
        ...
        self.useCHalf = QRadioButton('Use C 1/2 range')
        ...
        self.useIoverSig = QRadioButton(u'Use I/\u03C3(I) range')
        ...
        self.Rmerge_low.updateValue = update_maximum(self.Rmerge_low, self.Rmerge_up)
        self.Rmerge_up.updateValue = update_minimum(self.Rmerge_up, self.Rmerge_low)
        ...
        self.CHalf_low.updateValue = update_minimum(self.CHalf_low, self.CHalf_up)
        self.CHalf_up.updateValue = update_maximum(self.CHalf_up, self.CHalf_low)
        ...
        self.IoverSig_low.updateValue = update_minimum(self.IoverSig_low, self.IoverSig_up)
        self.IoverSig_up.updateValue = update_maximum(self.IoverSig_up, self.IoverSig_low)
